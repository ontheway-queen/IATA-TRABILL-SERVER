...
class Trxns extends abstract_services_1.default {
    constructor(req, trx) {
        ...
        this.clTrxnInsert = (body) => __awaiter(this, void 0, void 0, function* () {
            const { ctrxn_amount, ctrxn_cl, ctrxn_created_at, ctrxn_note, ctrxn_particular_id, ctrxn_pax, ctrxn_pnr, ctrxn_route, ctrxn_type, ctrxn_voucher, ctrxn_airticket_no, ctrxn_pay_type, ctrxn_received_by, } = body;
        ...
        this.AccTrxnInsert = (body) => __awaiter(this, void 0, void 0, function* () {
            const { acctrxn_ac_id, acctrxn_pay_type, acctrxn_particular_id, acctrxn_created_at, acctrxn_type, acctrxn_amount, acctrxn_note, acctrxn_created_by, acctrxn_voucher, } = body;
            const accBody = {
        ...
        this.AccTrxnUpdate = (body) => __awaiter(this, void 0, void 0, function* () {
            const { acctrxn_ac_id, acctrxn_amount, acctrxn_created_at, acctrxn_note, acctrxn_particular_id, acctrxn_pay_type, acctrxn_type, trxn_id, } = body;
            const acTrxnBody = {
        ...
        this.clTrxnUpdate = (body) => __awaiter(this, void 0, void 0, function* () {
            const { ctrxn_amount, ctrxn_cl, ctrxn_created_at, ctrxn_note, ctrxn_particular_id, ctrxn_pax, ctrxn_pnr, ctrxn_airticket_no, ctrxn_route, ctrxn_type, ctrxn_trxn_id, ctrxn_voucher, ctrxn_pay_type, } = body;
            const { client_id, combined_id } = (0, common_helper_1.separateCombClientToId)(ctrxn_cl);
            if (client_id) {
                const clTrxnBody = {
        ...
        this.VTrxnInsert = (body) => __awaiter(this, void 0, void 0, function* () {
            const { comb_vendor, vtrxn_voucher, vtrxn_pax, vtrxn_airticket_no, vtrxn_pnr, vtrxn_route, vtrxn_type, vtrxn_amount, vtrxn_particular_id, vtrxn_note, vtrxn_user_id, vtrxn_created_at, vtrxn_pay_type, } = body;
        ...
        this.VTrxnUpdate = (body) => __awaiter(this, void 0, void 0, function* () {
            const { comb_vendor, trxn_id, vtrxn_pax, vtrxn_type, vtrxn_amount, vtrxn_particular_id, vtrxn_note, vtrxn_user_id, vtrxn_created_at, vtrxn_voucher, vtrxn_airticket_no, vtrxn_pnr, vtrxn_route, vtrxn_pay_type, } = body;
            const { vendor_id, combined_id } = (0, common_helper_1.separateCombClientToId)(comb_vendor);
            if (vendor_id) {
                const VTrxnBody = {
                    p_trxn_id: trxn_id,
