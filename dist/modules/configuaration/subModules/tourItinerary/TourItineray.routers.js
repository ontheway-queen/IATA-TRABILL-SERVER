...
const TourItineray_controllers_1 = __importDefault(require("./TourItineray.controllers"));
class TourItinerayRouters extends abstract_routers_1.default {
    constructor() {
        super();
        this.controller = new TourItineray_controllers_1.default();
        this.callRouter();
    }
    callRouter() {
        // =============== GROUP ====================
        this.routers.get('/vendor/info/:id', this.controller.getTourVendorsInfo);
        this.routers.get('/accm-vendor/info/:id', this.controller.getTourVendorByAccmId);
        ...
        this.routers.get('/cities/by-country/:id', this.controller.getAllCityByCountries);
        // =============== ACCOMMODATION ====================
        this.routers.post('/accommodation/create', this.controller.createTourAccmmdtoins);
        this.routers.get('/all-countries', this.controller.getAllCountries);
        this.routers.patch('/accommodation/update/:id', this.controller.updateTourAccmmdtoins);
        this.routers.delete('/accommodation/delete/:id', this.controller.deleteTourAccmmdtoins);
        this.routers.get('/accommodation/get-all', this.controller.getAllAccommodation);
...
exports.default = TourItinerayRouters;
//# sourceMappingURL=TourItineray.routers.js.map