...
class DashboardModels extends abstract_models_1.default {
    constructor() {
        ...
        this.getTicketInfoByRefund = (ticket_no) => __awaiter(this, void 0, void 0, function* () {
            const [ticket] = yield this.query()
                .select('atrefund_vouchar_number', { refund_id: 'vrefund_refund_id' }, 'client_name', 'comb_client', 'refund_type', 'vrefund_total_amount', 'vrefund_charge_amount', 'vrefund_date', 'airticket_ticket_no', 'airline_name')
