    ...
    constructor() {
        ...
        this.getTicketInfoByTicket1 = (ticket_no) => __awaiter(this, void 0, void 0, function* () {
            const [ticket] = yield this.query()
                ...
                this.db.raw('ROUND(COALESCE(iat.airticket_gross_fare, ir.airticket_client_price)) as gross_fare'),
                this.db.raw('ROUND(COALESCE(iat.airticket_base_fare, ir.airticket_fare_difference)) as base_fare'),
                ...
                this.db.raw('ROUND(COALESCE(iat.airticket_ait, ir.airticket_ait)) as ait'),
                this.db.raw('ROUND(COALESCE(iat.airticket_purchase_price, ir.airticket_purchase_price)) as purchase_price'),
                'airline_code',
                'client_name',
                'invoice_sales_date',
            ])
