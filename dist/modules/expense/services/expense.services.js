    ...
    constructor() {
        ...
        this.addExpense = (req) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (expense_payment_type !== 4 && expense_accounts_id) {
                    // account transaction
                    let accPayType = (0, lib_1.getPaymentType)(expense_payment_type);
                    const AccTrxnBody = {
        ...
        this.editExpense = (req) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const trxns = new Trxns_1.default(req, trx);
                const files = req.files;
                const { expense_payment_type: prev_ex_type, prevAccTrxnId, expense_charge_id, expense_voucher_url_1, expense_voucher_url_2, } = yield conn.getExpense(expense_id);
        ...
        this.deleteExpense = (req) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                const conn = this.models.expenseModel(req, trx);
                const trxns = new Trxns_1.default(req, trx);
                const { expense_payment_type, expense_acctrxn_id, expense_total_amount, expense_charge_id, expense_voucher_url_1, expense_voucher_url_2, } = yield conn.getPreviousData(expense_id);
