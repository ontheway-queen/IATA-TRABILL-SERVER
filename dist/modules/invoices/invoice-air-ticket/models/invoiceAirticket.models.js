...
class InvoiceAirticketModel extends abstract_models_1.default {
    constructor() {
        ...
        this.getAirTicketBilling = (invoiceId) => __awaiter(this, void 0, void 0, function* () {
            return yield this.query()
                .select('airticket_id', 'airticket_ticket_no', 'passport_passport_no as passport_no', this.db.raw('COALESCE(p_passport_name, passport_name) as passport_name'), this.db.raw('COALESCE(p_passport_type, passport_person_type) as passport_type'), this.db.raw('COALESCE(p_mobile_no, passport_mobile_no) as passport_mobile'), this.db.raw('COALESCE(p_email, passport_email) as passport_email'), 'airticket_pnr', 'airticket_classes', 'airticket_ticket_type', 'airticket_routes', 'airticket_journey_date', 'airticket_return_date', 'airticket_gross_fare', 'airticket_extra_fee', 'airticket_client_price', 'airticket_is_refund', 'airticket_is_reissued', 'airticket_is_void')
                .from('trabill_invoice_airticket_items')
                .leftJoin('view_airticket_routes', function () {
                this.on('airoute_invoice_id', '=', 'airticket_invoice_id').andOn('airoute_airticket_id', '=', 'airticket_id');
            })
        ...
        this.voidAirticketItems = (airticket_id, invoice_id, deleted_by) => __awaiter(this, void 0, void 0, function* () {
            // 1. flight details
            yield this.query()
                .update({ fltdetails_is_deleted: 1, fltdetails_deleted_by: deleted_by })
                .into('trabill_invoice_airticket_items_flight_details')
    ...
    getInvoiceInfoForVoid(invoice_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const vendors = yield this.query()
                .select('airticket_id', 'vendor_name', this.db.raw("COALESCE(CONCAT('vendor-', airticket_vendor_id), concat('combined-', airticket_vendor_combine_id)) as comb_vendor"), 'airticket_client_price as sales', 'airticket_purchase_price as cost_price', 'airticket_ticket_no')
                .from('view_all_airticket_details')
                .where({ invoice_id });
    ...
    insertFakeInvoicePassport(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const [id] = yield this.query()
                .insert(data)
    ...
    deleteFakeInvoicePassport(invoice_id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.query()
    ...
    deleteInvoiceInfoItems(invoice_id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.query()
    ...
    getInvoiceInfo(invoice_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const passports = yield this.query()
                .select(`tip_id`, `tip_invoice_id`, `tip_name`, `tip_pax_type`, `tip_passport_no`, `tip_mobile_no`, `tip_email`, `tip_dob`, `tip_doi`, `tip_doe`)
