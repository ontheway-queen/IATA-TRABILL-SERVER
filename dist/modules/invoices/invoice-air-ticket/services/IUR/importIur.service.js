        ...
        this.create = (req) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const ticketDetails = body.ticketInfo.map((item) => {
                    ...
                    const airticket_net_commssion = (0, lib_1.numRound)(tkt.airticket_commission_percent_total) -
                        airticket_ait +
                        taxesCommission;
                    const airticket_profit = airticket_net_commssion;
                    const airticket_purchase_price = (0, lib_1.numRound)(tkt.airticket_gross_fare) - airticket_net_commssion;
                    invoice_sub_total += (0, lib_1.numRound)(tkt.airticket_client_price);
                    invoice_profit += (0, lib_1.numRound)(airticket_profit);
                    invoice_total_vendor_price += (0, lib_1.numRound)(airticket_purchase_price);
                ...
                const invoiceData = Object.assign(Object.assign({}, clientTransId), { invoice_category_id: 1, invoice_client_id: client_id, invoice_combined_id: null, invoice_net_total: invoice_sub_total, invoice_no: invoice_no, invoice_sales_date: body.issue_date, invoice_sales_man_id,
                    invoice_sub_total, invoice_note: 'THIS IS A SOFTWARE GENERATED INVOICE COPY/IUR', invoice_created_by: req.user_id, invoice_total_vendor_price, invoice_reissue_client_type: 'IUR' });
