                    ...
                    if ((pax_passports === null || pax_passports === void 0 ? void 0 : pax_passports.length) && pax_passports[0] && airticketId) {
                        for (const passport of pax_passports) {
                            if (passport.passport_id && passport.is_deleted) {
                                ...
                                yield common_conn.insertInvoiceAirticketPaxName(invoice_id, airticketId, passport === null || passport === void 0 ? void 0 : passport.passport_name, passport.passport_mobile_no, passport.passport_email, passport.passport_person_type);
                            }
                        }
                    }
