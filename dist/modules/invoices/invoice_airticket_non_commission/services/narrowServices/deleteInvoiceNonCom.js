...
class DeleteNonComInvoice extends abstract_services_1.default {
    constructor() {
        super();
        this.deleteNonComInvoice = (req, voidTran) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield conn.deleteNonCommissionItems(invoice_id, req.user_id);
                yield common_conn.deleteInvoices(invoice_id, req.user_id);
                yield this.insertAudit(req, 'delete', `Invoice air ticket non commission has been deleted`, req.user_id, 'INVOICES');
                return {
                    success: true,
        ...
        this.voidNonCommission = (req) => __awaiter(this, void 0, void 0, function* () {
...
exports.default = DeleteNonComInvoice;
//# sourceMappingURL=deleteInvoiceNonCom.js.map