...
class AddReissueAirticket extends abstract_services_1.default {
    constructor() {
        super();
        this.addReissueAirticket = (req) => __awaiter(this, void 0, void 0, function* () {
            const { invoice_info, ticketInfo, money_receipt } = req.body;
            const { invoice_combclient_id, invoice_created_by, invoice_net_total, invoice_vat, invoice_service_charge, invoice_discount, invoice_agent_id, invoice_agent_com_amount, invoice_sales_date, invoice_due_date, invoice_sales_man_id, invoice_sub_total, invoice_note, invoice_show_passport_details, invoice_show_prev_due, invoice_show_discount, invoice_reference, } = invoice_info;
            ...
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const invoice_information = Object.assign(Object.assign({}, clientTransId), { invoice_combined_id,
                    ...
                    invoice_sub_total,
                    invoice_note, invoice_category_id: 3, invoice_client_previous_due, invoice_no: invoice_no, invoice_reissue_client_type: 'NEW', invoice_reference,
                    invoice_total_profit,
                    invoice_total_vendor_price });
                const invoice_id = yield common_conn.insertInvoicesInfo(invoice_information);
                // AGENT TRANSACTION
                yield invoice_helpers_1.default.invoiceAgentTransactions(this.models.agentProfileModel(req, trx), req.agency_id, invoice_agent_id, invoice_id, invoice_no, invoice_created_by, invoice_agent_com_amount, 'CREATE', 94, 'AIR TICKET REISSUE ');
                ...
                for (const ticket of ticketInfo) {
                    ...
                    const { airticket_purchase_price, airticket_comvendor, airticket_ticket_no, airticket_route_or_sector, airticket_pax_name, airticket_pnr } = ticket_details, restAirticketItems = __rest(ticket_details, ["airticket_purchase_price", "airticket_comvendor", "airticket_ticket_no", "airticket_route_or_sector", "airticket_pax_name", "airticket_pnr"]);
                    ...
                    const invoiceNonComAirticketItems = Object.assign(Object.assign({}, restAirticketItems), { airticket_purchase_price, airticket_client_id: invoice_client_id, airticket_combined_id: invoice_combined_id, airticket_invoice_id: invoice_id, airticket_sales_date: invoice_sales_date, airticket_vendor_id: vendor_id, airticket_vendor_combine_id: combined_id, airticket_vtrxn_id,
                        airticket_ticket_no,
                        airticket_pax_name,
                        airticket_pnr });
                    const airticket_id = yield conn.insertReissueAirTicketItems(invoiceNonComAirticketItems);
...
exports.default = AddReissueAirticket;
//# sourceMappingURL=addInvoiceReissue.js.map