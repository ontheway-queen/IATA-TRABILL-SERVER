...
class UmmrahRefundServices extends abstract_services_1.default {
    constructor() {
        super();
        this.refund = (req) => __awaiter(this, void 0, void 0, function* () {
            ...
            const voucher_no = (0, invoice_helpers_1.generateVoucherNumber)(4, 'URF');
            return yield this.models.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (const billing of billing_info) {
                    ...
                    yield conn.updateUmmrahBillingRemainingQuantity(billing_id, refund_quantity);
                    refundItemsInfo.push(refundItem);
                }
                if (refundItemsInfo.length)
                    yield conn.createUmmrahRefundItems(refundItemsInfo);
                const history_data = {
                ...
                yield conn.updateUmmrahInvoiceIsRefund(invoice_id, 1);
                yield this.insertAudit(req, 'create', 'Ummrah refund has been created', created_by, 'HAJJ_MGT');
                return {
                    success: true,
...
exports.default = UmmrahRefundServices;
//# sourceMappingURL=ummrahRefund.services.js.map