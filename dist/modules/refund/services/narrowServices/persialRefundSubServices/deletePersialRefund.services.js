        ...
        return yield this.models.db.transaction((trx) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const { prfnd_invoice_id, prfnd_vouchar_number } =
              yield conn.getPersialRfndInvoiceId(refund_id);
            const { invoice_category_id } = yield conn.getInvoiceInfo(
              prfnd_invoice_id
            );
            const {
              prfnd_actrxn_id,
              ...
              prfnd_trxn_id,
              comb_client,
            } = yield conn.getPersialRfndInfo(refund_id);
            if (prfnd_actrxn_id) {
            ...
            const persialVendorRefundInfo =
              yield conn.getPersialRefundVendorInfo(refund_id);
            ...
            return {
              success: true,
              message: 'Persial refund deleted successfuly',
            };
          })
        );
      });
