...
class ReportRouter extends abstract_routers_1.default {
    ...
    callRouter() {
        ...
        this.routers.get('/invoice-money-receipt-discount', this.controllers.invoiceAndMoneyReceiptDiscount);
        /**
         * PROFIT LOSS
         */
        ...
        this.routers.get('/overall-client-purchase', this.controllers.getOverallPurchase);
