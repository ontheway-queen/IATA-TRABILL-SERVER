...
class AccountsRouter extends AbstractRouter {
  private controllers = new AccountsControllers();
  ...
  private callRouter() {
    ...
    this.routers.get(
      ...
      this.controllers.accountStatement
    );

    // GET SINGLE ACCOUNT
    this.routers.get(
      '/single-account/:account_id',
      this.controllers.getSingleAccount
    );

    // Transaction History
    this.routers.get(
      '/transaction-history/:account_id',
      this.controllers.accountTransaction
    );
    ...
    this.routers.delete(
      '/opening-balance/:id',
      this.controllers.deleteAccOpeningBalance
    );
    ...
    this.routers.get(
      ...
      this.controllers.getTrasnfrbleAcc
    );
    this.routers
    ...
    this.routers.get(
      '/account-by-type/:type_id',
      this.controllers.getAccountByType
    );
