...
class SendMail extends AbstractServices {
  constructor() {
    super();
  }

  public sendEmail = async (req: Request) => {
    ...
    return await this.models.db.transaction(async (trx) => {
      ...
      const {
        ...
        invoice_no,
        invoice_sales_date,
      } = await conn.getInvoiceClientInfo(invoice_id);
      ...
      const {
        ...
        org_owner_email,
        org_address1,
      } = await conn.getAgencyInfo(invoice_org_agency);
      ...
      const airticket_information = await conn.getViewAirticketItems(
        invoice_id
      );
                      ...
                      <div
                          ...
                          <div>
                              ...
                              <p style="margin:  0;padding: 0, 3px;  font-size: 15px; font-weight: 600;">Invoice Date :
                                  <span style="font-weight: 500;">${moment(
                                    new Date(invoice_sales_date)
                              ...
                              ${flights
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td style="padding: 5px; text-align: center; width: auto; border: 1px solid #ddd;">${
                                      f_info?.fltdetails_departure_time || ''
                                    }</td>
                                    <td style="padding: 5px; text-align: center; width: auto; border: 1px solid #ddd;">${
                                      f_info?.fltdetails_arrival_time || ''
                                    }</td>
                                  </tr>
                                </tbody>
                              `
                            ...
                            .map(
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                        pax_info?.passport_name || ''
                                      }
                                      </td>
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                        pax_info?.passport_person_type || ''
                                      }
                                      </td>
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                        pax_info?.passport_passport_no || ''
                                      }
                                      </td>
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">
                                          ${pax_info?.passport_nid_no || ''}
                                      </td>
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">
                                          ${pax_info?.passport_mobile_no || ''}
                                      </td>
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">
                                          ${
                                            pax_info?.passport_date_of_issue
                                              ? moment(
                                                  new Date(
                                                    pax_info?.passport_date_of_issue
                                                  )
                                      ...
                                      <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">
                                          ${
                                            pax_info?.passport_date_of_expire
                                              ? moment(
                                                  new Date(
                                                    pax_info?.passport_date_of_expire
                                                  )
                      ...
                      <table style="width: 100%;border-collapse: collapse;">
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_ticket_no || ''
                                  }
                                  </td>
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_pnr || ''
                                  }
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_classes || ''
                                  }
                                  </td>
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_routes || ''
                                  }</td>
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_journey_date
                                      ? moment(
                                          new Date(
                                            ait_billing?.airticket_journey_date
                                          )
                                  ...
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_return_date
                                      ? moment(
                                          new Date(
                                            ait_billing?.airticket_return_date
                                          )
                                  ...
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_gross_fare || 0
                                  }</td>
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_discount_total || 0
                                  }
                                  </td>
                                  <td style="padding: 5px;text-align: center;width: auto; border: 1px solid #ddd;">${
                                    ait_billing?.airticket_gross_fare -
                                      ait_billing?.airticket_discount_total || 0
                                  }
                                  </td>
                              </tr>
                  ...
                  <div
                      ...
                      <div style="display: flex; ">
                          <p
                              ...
                              Sub Total</p>
                          <p style="padding: 2px 10px; width: 50%; margin: 0px;">${
      ...
      const { client_email } = await conn.getClientCombineClientMail(
        client_id,
        combined_id
      );
      ...
      if (client_email && expression.test(client_email)) {
        mail = await SendEmailHelper.sendEmail(message);
      } else {
